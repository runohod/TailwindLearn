import { redFingerBuilding, cubesBuilding, thePencilBuilding } from "@/shared/assets";
    ...
    <section className="pb-60">
      <div className="max-w-1230 mx-auto px-24 mt-120 flex items-end justify-between mb-60">
        ...
        <div className="flex items-center gap-3 shrink-0 mb-2">
            <button className="w-12 h-12 rounded-full flex items-center justify-center border border-transparent hover:bg-primary text-gray-text hover:text-white transition-all group">
      ...
      <div className="max-w-1230 flex gap-7.5 mb-20 justify-center mx-auto">
        <div className="bg-white rounded shadow-sm overflow-hidden flex flex-col group cursor-pointer hover:shadow-xl transition-shadow">
            ...
            <div className="p-6 text-center flex flex-col items-center">
              <h3 className="text-[20px] font-bold text-dark mb-1">Red Finger Building</h3>
        ...
        <div className="bg-white rounded shadow-sm overflow-hidden flex flex-col group cursor-pointer hover:shadow-xl transition-shadow">
            ...
            <div className="p-6 text-center flex flex-col items-center">
              <h3 className="text-[20px] font-bold text-dark mb-1">Cubes Building</h3>
              <p className="text-[14px] text-text-comment">Business Centers</p>
            </div>
        </div>
        <div className="bg-white rounded shadow-sm overflow-hidden flex flex-col group cursor-pointer hover:shadow-xl transition-shadow">
            ...
            <div className="p-6 text-center flex flex-col items-center">
              <h3 className="text-[20px] font-bold text-dark mb-1">The Pencil Building</h3>
