...
export const Services = () => {
  return (
    <section
      ...
      className="bg-[image:var(--bg-services)] bg-cover bg-center bg-no-repeat pt-16 pb-20 md:pt-20 md:pb-28 lg:pb-32"
    >
      <div className="container-custom px-4 md:px-0">
        <h2 className="text-3xl sm:text-4xl md:text-[46px] font-black leading-tight text-dark text-center">
          Our core values
        </h2>
        <div className="mt-4 mb-10 md:mt-6 md:mb-14 text-base md:text-[18px] text-text-comment text-center max-w-2xl mx-auto">
      ...
      <div className="max-w-1200 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-12 md:mb-20 mx-auto px-4 xl:px-0">
        <div className="bg-white border border-[#E5E8ED] rounded shadow-sm aspect-square flex flex-col items-center justify-center p-6 hover:shadow-xl transition-shadow cursor-pointer group hover:bg-orange-600 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-orange-600/30 active:scale-95 active:translate-y-0 cursor-pointer">
          ...
          >
            <g clipPath="url(#clip0_178063_2125)">
              <path
                d="M50.4766 27.5234C51.3179 27.5234 52 26.8413 52 26V14.625C52 13.7837 51.3179 13.1016 50.4766 13.1016C49.4146 13.1016 28.668 13.1016 27.5234 13.1016V3.25C27.5234 2.40866 26.8413 1.72656 26 1.72656H9.75C8.90866 1.72656 8.22656 2.40866 8.22656 3.25V13.1016H1.52344C0.682094 13.1016 0 13.7837 0 14.625V26C0 26.8413 0.682094 27.5234 1.52344 27.5234H8.22656V35.8516H1.52344C0.682094 35.8516 0 36.5337 0 37.375V48.75C0 49.5913 0.682094 50.2734 1.52344 50.2734H50.4766C51.3179 50.2734 52 49.5913 52 48.75V37.375C52 36.5337 51.3179 35.8516 50.4766 35.8516H43.7734V27.5234H50.4766ZM48.9531 24.4766C47.3232 24.4766 37.2597 24.4766 35.6484 24.4766V16.1484H48.9531V24.4766ZM32.6016 24.4766C31.0059 24.4766 21.0046 24.4766 19.3984 24.4766V16.1484H32.6016V24.4766ZM11.2734 4.77344H24.4766V13.1016C22.8809 13.1016 12.8796 13.1016 11.2734 13.1016V4.77344ZM3.04688 24.4766V16.1484H16.3516V24.4766C14.7396 24.4766 4.67645 24.4766 3.04688 24.4766ZM11.2734 27.5234H24.4766V35.8516C22.8809 35.8516 12.8796 35.8516 11.2734 35.8516V27.5234ZM3.04688 38.8984H16.3516V47.2266H3.04688V38.8984ZM19.3984 38.8984H32.6016V47.2266H19.3984V38.8984ZM48.9531 38.8984V47.2266H35.6484V38.8984H48.9531ZM40.7266 35.8516C39.1309 35.8516 29.1296 35.8516 27.5234 35.8516V27.5234H40.7266V35.8516Z"
                fill="#FF5A30"
              />
            </g>
            <defs>
              <clipPath id="clip0_178063_2125">
                <rect width="52" height="52" fill="white" />
              </clipPath>
            </defs>
          </svg>
          <div className="text-[20px] font-bold text-dark text-center">
            Construction
          </div>
        </div>
        ...
        <div className="bg-white border border-[#E5E8ED] rounded shadow-sm aspect-square flex flex-col items-center justify-center p-6 hover:shadow-xl transition-shadow cursor-pointer group hover:bg-orange-600 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-orange-600/30 active:scale-95 active:translate-y-0 cursor-pointer">
          <svg
            ...
            className="mb-4 md:mb-6"
          >
            <g clipPath="url(#clip0_178063_2053)">
              <path
                d="M45.9062 3.14844C43.6552 3.14844 41.6854 4.37521 40.6303 6.19531H1.52344C0.682094 6.19531 0 6.87741 0 7.71875V47.3281C0 48.1695 0.682094 48.8516 1.52344 48.8516H45.9062C49.2663 48.8516 52 46.1179 52 42.7578V9.24219C52 5.88209 49.2663 3.14844 45.9062 3.14844ZM45.9062 45.8047C45.3103 45.8047 3.6011 45.8047 3.04688 45.8047V9.24219H39.8125V42.7578C39.8125 43.5992 40.4946 44.2812 41.3359 44.2812C42.1773 44.2812 42.8594 43.5992 42.8594 42.7578C42.8594 41.0778 44.2262 39.7109 45.9062 39.7109C47.5863 39.7109 48.9531 41.0778 48.9531 42.7578C48.9531 44.4379 47.5863 45.8047 45.9062 45.8047ZM48.9531 37.4818C48.0563 36.9619 47.0153 36.6641 45.9062 36.6641C44.7972 36.6641 43.7562 36.9619 42.8594 37.4818V9.24219C42.8594 7.56214 44.2262 6.19531 45.9062 6.19531C47.5863 6.19531 48.9531 7.56214 48.9531 9.24219V37.4818Z"
                fill="#FF5A30"
              />
              <path
                d="M35.1406 12.2891H7.71875C6.87741 12.2891 6.19531 12.9712 6.19531 13.8125V41.2344C6.19531 42.0757 6.87741 42.7578 7.71875 42.7578H22.9531C23.3572 42.7578 23.7446 42.5972 24.0303 42.3115C24.3161 42.0259 24.4766 41.6384 24.4766 41.2344V38.1875C24.4766 36.2013 25.7501 34.507 27.5234 33.8782V41.2344C27.5234 42.0757 28.2055 42.7578 29.0469 42.7578H35.1406C35.982 42.7578 36.6641 42.0757 36.6641 41.2344V13.8125C36.6641 12.9712 35.982 12.2891 35.1406 12.2891ZM33.6172 39.7109H30.5703V32.0938C30.5703 31.2524 29.8882 30.5703 29.0469 30.5703C24.8468 30.5703 21.4297 33.9874 21.4297 38.1875V39.7109H9.24219V30.5703H15.3359V35.1406C15.3359 35.982 16.018 36.6641 16.8594 36.6641C17.7007 36.6641 18.3828 35.982 18.3828 35.1406V29.0469C18.3828 28.2055 17.7007 27.5234 16.8594 27.5234H9.24219V15.3359H18.3828V21.4297H13.8125C12.9712 21.4297 12.2891 22.1118 12.2891 22.9531C12.2891 23.7945 12.9712 24.4766 13.8125 24.4766H19.9062H26C26.8413 24.4766 27.5234 23.7945 27.5234 22.9531C27.5234 22.1118 26.8413 21.4297 26 21.4297H21.4297V15.3359H33.6172V39.7109Z"
                fill="#FF5A30"
              />
            </g>
            <defs>
              <clipPath id="clip0_178063_2053">
                <rect width="52" height="52" fill="white" />
              </clipPath>
            </defs>
          </svg>
        ...
        <div className="relative overflow-hidden rounded shadow-sm aspect-square flex flex-col items-center justify-center p-6 cursor-pointer group hover:bg-orange-600 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-orange-600/30 active:scale-95 active:translate-y-0 cursor-pointer">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <svg
              ...
              className="mb-4 md:mb-6"
            >
              <g clipPath="url(#clip0_179502_1985)">
                <path
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center text-center sm:text-left gap-6 md:gap-10 px-4">
